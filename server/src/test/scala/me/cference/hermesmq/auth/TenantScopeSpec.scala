...
final class TenantScopeSpec extends AnyWordSpec with Matchers:
  ...
  "TenantScope" should {
    ...
    "reject an external id containing the reserved separator" in {
      val _ = TenantScope.validateExternalId("a~b").isLeft shouldBe true
