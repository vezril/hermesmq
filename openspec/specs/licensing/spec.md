...
Define the project's open-source license: an MIT `LICENSE` file at the repository root, referenced from the README and declared in build metadata, with no conflicting license claims.
