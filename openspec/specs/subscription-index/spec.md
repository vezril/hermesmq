# subscription-index Specification

## Purpose

Define the durable, cluster-shared topic→subscriptions read model: a projection over SubscriptionCreated events maintaining a queryable table, replacing the per-node in-memory index.
