...
Define the immutable, validated value types of the broker domain: type-safe identifiers, the `Message` envelope, and the acknowledgement deadline — the building blocks the aggregates operate on.
