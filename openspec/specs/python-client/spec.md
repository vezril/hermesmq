# python-client Specification

## Purpose

Define the Python 3 client library — a typed, synchronous API over the REST endpoints, packaged under clients/python with httpx as its only runtime dependency.
