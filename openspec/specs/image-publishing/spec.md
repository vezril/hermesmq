...
Define publishing the Docker image to Docker Hub: the versioned + `latest` tagging scheme, credential handling, and the release/development publish triggers (single-platform `linux/amd64`).
