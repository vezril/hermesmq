...
Define a complete README front page: a clear project description, CI/CD status badges, an honest AI usage disclaimer, and copy-pasteable deployment and configuration examples.
