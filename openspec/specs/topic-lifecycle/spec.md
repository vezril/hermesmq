...
Define the Topic aggregate's pure write-side logic: creating a topic and publishing messages, expressed as total `decide`/`evolve` functions with explicit rejections.
